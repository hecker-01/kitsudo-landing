    ...
    <div class="container-tight max-w-2xl">
      <div class="terminal-box pixel-corners p-5 sm:p-7">
        <div class="mb-4 flex items-center gap-3 border-b border-outline pb-3">
          ...
          <span class="text-xs text-on-surface-muted">kitsudo@boot — /dev/tty0</span>
        </div>

        <pre class="min-h-[12rem] whitespace-pre-wrap break-words text-sm leading-relaxed sm:text-base">
