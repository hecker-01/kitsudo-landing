...
<template>
    <footer class="border-t border-outline bg-surface-highest">
        <div
            class="container-tight grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-3"
        >
            <!-- about -->
            <div>
            ...
            <div>
                <h4
                    class="cmd-heading mb-4 font-mono text-sm font-bold text-on-surface"
                >
                    links
                </h4>
                <ul class="space-y-2 text-sm text-on-surface-muted">
                    ...
                    <li>
                        <RouterLink to="/privacy" class="hover:text-primary"
                            >→ Privacy</RouterLink
                        >
                    </li>
                </ul>
